...
Version  : 2.3.8
Release  : 20
URL      : https://mirrors.kernel.org/gnu/libidn/libidn2-2.3.8.tar.gz
Source0  : https://mirrors.kernel.org/gnu/libidn/libidn2-2.3.8.tar.gz
Source1  : https://mirrors.kernel.org/gnu/libidn/libidn2-2.3.8.tar.gz.sig
Source2  : 51722B08FE4745A2.pkey
Summary  : Library implementing IDNA2008 and TR46
Group    : Development/Tools
License  : GPL-3.0 LGPL-3.0 Unicode-TOU
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) 51722B08FE4745A2' gpg.status
%setup -q -n libidn2-2.3.8
cd %{_builddir}/libidn2-2.3.8
pushd ..
cp -a libidn2-2.3.8 build32
popd
pushd ..
cp -a libidn2-2.3.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742421752
...
cp %{_builddir}/libidn2-%{version}/COPYING %{buildroot}/usr/share/package-licenses/libidn2/31a3d460bb3c7d98845187c716a30db81c44b615 || :
cp %{_builddir}/libidn2-%{version}/COPYING.LESSERv3 %{buildroot}/usr/share/package-licenses/libidn2/a8a12e6867d7ee39c21d9b11a984066099b6fb6b || :
...
/usr/share/gtk-doc/html/libidn2/api-index-2.3.5.html
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/libidn2/31a3d460bb3c7d98845187c716a30db81c44b615
/usr/share/package-licenses/libidn2/33ad3570b2dc646e18e97171233bfceda6f7f088
/usr/share/package-licenses/libidn2/a8a12e6867d7ee39c21d9b11a984066099b6fb6b
